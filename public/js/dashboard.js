                        ...
                        '<div class="card">' +
                            ...
                            '<div id="collapse_' + device.deviceId + '" class="collapse show" aria-labelledby="heading_' + device.deviceId + '" data-parent="#accordion">' +
                                '<div class="card-body text-dark">' +
                                                        '<div>' +
                            '1: <input id="switch-' + device.deviceId + '-0" class="switch" type="checkbox" /><br/>' + 
                            '2: <input id="switch-' + device.deviceId + '-1" class="switch" type="checkbox" /><br/>' +
                            '3: <input id="switch-' + device.deviceId + '-2" class="switch" type="checkbox" /><br/>' +
                            '4: <input id="switch-' + device.deviceId + '-3" class="switch" type="checkbox" /><br/>'+
                            '5: <input id="switch-' + device.deviceId + '-4" class="switch" type="checkbox" /><br/>' +
                        '</div>' +
                                '</div>' +
                            '</div>' +
                        '</div>'
